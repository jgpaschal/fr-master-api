const rules = {
    ...
    "rules": {
        ...
        "no-empty-class": 0, // disallow the use of empty character classes in regular expressions(deprecated)
        "no-empty-character-class" : 2, // Disallow Empty Character Classes
        ...
        "no-reserved-keys": 0, // disallow reserved words being used as object literal keys (off by default) (deprecated)
        ...
        "no-wrap-func": 0, // disallow wrapping of non-IIFE statements in parens(deprecated)
        ...
        "space-in-brackets": [0, "never"], // require or disallow spaces inside brackets (deprecated)
        "array-bracket-spacing": [1, "never"], // require or disallow spaces inside brackets
        "computed-property-spacing": [1, "never"], // require or disallow spaces inside brackets
        ...
        "spaced-line-comment": [0, "always"], // require or disallow a space immediately following the // in a line comment (deprecated)
        "spaced-comment": [1, "always"], // Requires or disallows a whitespace
